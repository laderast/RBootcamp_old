...
Before we even start with manipulating data with R, we're going to talk about aesthetics. Look at the plot below. What is mapped to the x aesthetic?
...
ggplot(bad_drivers, aes(x = year, y = month, size = births)) + geom_point()
```
